...
function runDataQuery(restriction) {
    ...
    runQuery(query, results => {
        ...
        statusField.innerHTML = " SKANSENs digitala partners genereras. Vad status är just nu för <strong>"+typeLabel+"</strong>  "+deck.length+" cards. <a href=\"javascript:window.print()\" class=\"button\"><br /><br />Skansen jobbar med dessa och makes them SHINE?</a>";
    });
}
