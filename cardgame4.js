...
function runDataQuery(restriction) {
    ...
    runQuery(query, results => {
        ...
        statusField.innerHTML = " Grillplatser jobbkort genereras vad status är just nu för <strong>"+typeLabel+"</strong>  "+deck.length+" cards. <a href=\"javascript:window.print()\" class=\"button\"><br /></a>";
    });
}

function limitData(type) {
    var restriction = "?item wdt:P6104 wd:Q121313211.";
