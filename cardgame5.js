...
function runDataQuery(restriction) {
    ...
    runQuery(query, results => {
        ...
        statusField.innerHTML = " Utegym jobbkort genereras vad status är just nu för <strong>"+typeLabel+"</strong>  "+deck.length+" cards. <a href=\"javascript:window.print()\" class=\"button\"><br /></a>";
    });
}

function limitData(type) {
    var restriction = "?item wdt:P6104 wd:Q107186275.";
...
window.onload = function() {
    var type = window.location.search.substr(1) || "Q692630";
