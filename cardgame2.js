...
function runDataQuery(restriction) {
    ...
    runQuery(query, results => {
        ...
        statusField.innerHTML = "Arbetslivsmuseer jobbkort genereras <strong>"+typeLabel+"</strong>  "+deck.length+" cards. <a href=\"javascript:window.print()\" class=\"button\"><br /><br />Kontakta dom and make them SHINE?</a>";
    });
}
